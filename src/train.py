...
def main_herding():
    ...
    #}
    #model = PPO.load("brain_to_integrate", env=vec_env, custom_objects=custom_objects, tensorboard_log="./ppo_drone_tensorboard/", verbose=1)
    #with torch.no_grad():
    ...
    model.learn(total_timesteps=20_000_000, callback=swarm_callback, tb_log_name="PPO_Marathon")
    #saving result
    print("Training done...")
