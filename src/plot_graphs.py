...
def plot_master_comparison(data_dict, speeds, filename='comparison_coll_rate_4vs1.png'):
    ...
    width = 0.25  # Šířka jednoho sloupce
    
    fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(14, 6), sharey=True)
    
    # Barvy pro jednotlivé modely (A, B, C)
    colors = ['#4A90E2', '#50C878', '#FF9F43'] # Modrá, Zelená, Oranžová
    models = list(data_dict.keys())

    # --- LEVÝ GRAF: Without Obstacles ---
    ...
    # Jedna společná legenda uprostřed nahoře
