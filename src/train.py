...
def main_defense():
    ...
    init_brain_path = "./models/history_def/gen_18"
    ...
    model = PPO.load("./models/history_def/gen_18", env=vec_env, custom_objects=custom_objects, tensorboard_log="./ppo_drone_tensorboard/", verbose=1)
    # with torch.no_grad():
    ...
    model.learn(total_timesteps=4_600_000, callback=swarm_callback, tb_log_name="PPO_Defense", reset_num_timesteps=False)
    #saving result
    print("Training done...")
