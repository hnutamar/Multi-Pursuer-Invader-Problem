...
def main():
    ...
    #config
    if _3d:
        sc = Sim3DConfig(purs_num=30, inv_num=5, obstacle=True, obstacle_rad=[3.0, 4.0], obstacle_pos=[np.array([13.0, 13.0, 6.0]), np.array([17.0, 6.0, 3.0])])
    else:
        sc = Sim2DConfig(world_height=30, world_width=30, purs_num=20, inv_num=3, obstacle=True, 
    ...
    world = SimulationWorld(sc, _3d=_3d, purs_acc=2.8, inv_acc=0.7, prime_acc=0.3)
    #visualization
