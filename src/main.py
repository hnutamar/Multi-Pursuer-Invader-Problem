...
def main():
    ...
    #config
    if _3d:
        sc = Sim3DConfig(dt=0.02, purs_num=20, inv_num=10, obstacle=False, obstacle_rad=[3.0, 4.0], obstacle_pos=[np.array([13.0, 13.0, 6.0]), np.array([17.0, 6.0, 3.0])])
    else:
    ...
    def_model = PPO.load("./models/history_def/gen_18")
