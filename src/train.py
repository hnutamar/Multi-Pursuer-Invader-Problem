...
def main_herding():
    ...
    init_brain_path = "./models/history/gen_10"
    ...
    model = PPO.load("./models/history/gen_10", env=vec_env, custom_objects=custom_objects, tensorboard_log="./ppo_drone_tensorboard/", verbose=1)
    #with torch.no_grad():
