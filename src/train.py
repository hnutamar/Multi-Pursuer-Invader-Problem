...
def main_defense():
    ...
    init_brain_path = "./models/history_def/gen_16"
    ...
    model = PPO.load("./models/history_def/gen_6", env=vec_env, custom_objects=custom_objects, tensorboard_log="./ppo_drone_tensorboard/", verbose=1)
    # with torch.no_grad():
